        ...
        <div class="col-md-12">
            ...
            <div class="portlet box green">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-gift"></i>系統帳號使用者列表
                    </div>
                    <div class="tools">
...
@section('js')
    ...
    <script>
        ...
        var columnDefs = [
			...
			{headerName: "姓名", field: "nickname"},
            {headerName: "帳號", field: "username"},
        ...
        function editData() {
            if(gridOptions.api.getSelectedRows().length  > 0) {
                var row = gridOptions.api.getSelectedRows();
                document.location.href="/xdmin/manager/edit/"+row[0].id;
            } else {
                alert("請先選擇相對作業內容");
            }
        }
