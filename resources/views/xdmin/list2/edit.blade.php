        ...
        <div class="col-md-12">
            ...
            <div class="portlet box green">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    <form action="/xdmin/list2" method="post" class="form-horizontal">
                        {{ csrf_field() }}
                        ...
                        <div class="form-actions">
                            <div class="form-group">
                                <div class="col-md-3">
								  ...
								  <div class="col-md-3">
                                    <input type="checkbox" class="make-switch" name="education" value="Y" <?php if($data->education == 'Y') echo 'checked'?> data-on-color="success" data-off-color="warning"> 般若訊
                                </div>
								  <div class="col-md-3">
                                    <input type="checkbox" class="make-switch" name="recommend" value="Y" <?php if($data->recommend == 'Y') echo 'checked'?> data-on-color="success" data-off-color="warning"> 推薦閱讀
                                </div>
