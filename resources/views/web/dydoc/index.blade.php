                ...
                <div class="col-md-9 col-sm-8 col-xs-12 main-wrap"><!-- content area column -->
                    <div class="listing-section">
                        <div class="map_contain">
                            <!--================================PAGE TITLE==========================================-->
                            <div class="page_title">持有專利彙編<span class="right margin-right-20"><a href="{{$news->nextPageUrl()}}">下一頁</a></span><span class="right margin-right-20"><a href="{{$news->previousPageUrl()}}">上一頁</a></span></div>
																<hr></hr>
                            <!-- section container -->
                            <div class="roll_content news_page">
                                <ul>
                                    @foreach($news as $item)
                                        <li><span class="list_date">{{$item->post_date}}</span><span class="list_title"><a href="/dydoc/detail/{{$item->id}}">{{$item->title}}</a></span></li>
                                        @endforeach
