...
@section('content')
							...
							<div class="sidebar-widget">
								...
								<div class="sidebar-widget-content category-widget clearfix">
									<div class="sidebar-category-widget-wrap">
										<ul>
											<li><a href="#"> 海生館最新商品型錄 </a></li>
											<li><a href="#"> 海生館圖書與雜誌 </a></li>
											<li><a href="#"> 特價商品 </a></li>
											<li><a href="#"> 訂單進度查詢 </a></li>
										</ul>
									</div>
								</div>
							</div>
		...
		<!--================================BREADCRUMB SECTION==========================================-->
								<ul class="breadcrumb">
								  ...
								  <li class="breadcrumb-item"><a href="#">熱門商品</a></li>
								  <li class="breadcrumb-item"><a href="#">海生館最新商品型錄</a></li>
